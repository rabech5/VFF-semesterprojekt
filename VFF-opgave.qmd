...
# Bilag 4: Tematiserede interviews
...
# Bilag 5: Kode og datahåndtering
...
for(season_år in names(seasons)) {
  seasons[[season_år]]  mutate(ugedag = as.character(ugedag),
...
base_url <- "[https://dmigw.govcloud.dk/v2/](https://dmigw.govcloud.dk/v2/)"
...
base_url_dn <- "[https://date.nager.at/api/v3/PublicHolidays/](https://date.nager.at/api/v3/PublicHolidays/)"
country_code <- "/DK"
